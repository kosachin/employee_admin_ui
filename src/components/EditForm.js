...
const reqLen = (value) =>
  value.length === 10 ? undefined : "Length must be 10";
...
const setCity = (args, state, utils) => {
  // utils.changeValue(state, "dropdown", () => true);
  // console.log(args)
};
export const EditForm = () => {
  return (
    <div>
      <Form onSubmit={onSubmit} mutators={{ setCity }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <MobileNumberField
                ...
                component={"input"}
                type="number"
                validate={composeValidators(required, reqLen)}
              />
            </div> */}
            <div>
              <label>Address:</label>
              <div>
                <div>
                  <Field name="address" component={"input"} validate={required}>
                    {({ input, meta }) => (
                      <>
                        <label>address:</label>
                        <input {...input} />
                ...
                <div>
                  ...
                  <Field name="city" component={"select"} validate={required}>
                    <option value={null}></option>
                    {stateWiseCities.Maharashtra.map((e) => (
